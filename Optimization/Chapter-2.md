...
1. **Κρίσιμα σημεία**: Υπολογίζω πρώτες μερικές παραγώγους για να υπολογίσω την $\nabla$ της $f$, μετά λύνω $\nabla f = \begin{bmatrix} 0 & 0 & 0\end{bmatrix}^T$
2. **Εσσιανός**: Υπολογίζω δεύτερες μερικές παραγώγους για να υπολογίσω τον $\nabla^2$ της $f$
3. - Αντικαθιστώ στον $\nabla^2$ για κάθε κρίσιμο σημείο και πολλαπλασιάζω με $x_i x_j$ και αθροίζω για να πάρω την **τετραγωνική μορφή** $Q$, **ή**
   - **Πρωτεύουσες ελάσσονες ορίζουσες**: Υπολογίζω με βάση τον Εσσιανό και αντικαθιστώ στις ορίζουσες για κάθε κρίσιμο σημείο **ή**
   - χρησιμοποιώ τις **ιδιοτιμές** και αντικαθιστώ για κάθε κρίσιμο σημείο
```
